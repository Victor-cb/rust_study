...
fn main()-> BError {
    ...
    let context = BTermBuilder::new()
        .with_font("../resources/flappy_dragon.png", 32,32)
        .with_simple_console(SCREEN_WIDTH, SCREEN_HEIGHT, "../resources/flappy_dragon.png")
        .with_fancy_console(SCREEN_WIDTH,SCREEN_HEIGHT, "../resources/flappy_dragon.png")
